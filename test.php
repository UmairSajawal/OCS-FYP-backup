...
<nav class="navbar navbar-expand-lg navbar-dark bg-secondary fixed-top">
        <div class="container-fluid pt-1 pb-1">
            <a class="navbar-brand fs-4" href="index.php">Online Chef Service</a>
...
$mealDate = isset($_POST['mealDate']) ? $_POST['mealDate'] : '';
...
if ( ($myStep == 1) || (!$myStep) ) { ?>
    ...
    <form action="test.php?step=<?php echo $myStep; ?>" method="POST">
        <h2 style="margin-bottom: 30px;">We're located in...</h2>
        <input type="text" name="address" class="formControl" placeholder="Enter your address" required><br>
        <br>
...
<?php }else if ($myStep == 2) {  ?>
    ...
    <form action="test.php?step=<?php echo $myStep; ?>" method="POST">
        <h2 style="margin-top: -50px;">We're looking for a Private Chef for...</h2><br>
        <button class="btn-1" name="mealType" value="one-time">One-time experience</button><br><br><br>
        <button class="btn-2" name="mealType" value="multiple">Multiple meals</button><br><br>
    ...
    <?php } else if ($myStep == 3 && $mealType == 'one-time') {  ?>
    <div class="container step-three" style="text-align: center;">
    <form action="test.php?step=<?php echo $myStep; ?>" method="POST">
    <h1 style="margin-top: -50px;">We are...</h1>
        ...
        <br>
        <input type="hidden" name="step" value="4.5">
...
<?php } else if ($myStep == 3 && $mealType == 'multiple') {  ?>
    <div class="container step-three" style="text-align: center;">
    <form action="test.php?step=<?php echo $myStep; ?>" method="POST">
    <h1 style="margin-top: -50px;">Date range...</h1>
    ...
    <input type="date" id="end_date">
        ...
        <input type="hidden" name="address" value="<?php echo $_POST['address']; ?>">
        <input type="hidden" name="meal" value="<?php echo $_POST['meal']; ?>">
        <input type="hidden" name="mealType" value="<?php echo $_POST['mealType']; ?>">
        <button class="btnBack" type="button" onclick="history.back()">Back</button>
        <input type="submit">
        <br>
    </form>
...
<?php } else if ($myStep == 3.5 && $mealType == 'multiple') {  
?>
<div class="container step-three" style="text-align: center;">
    <form action="test.php?step=<?php echo $myStep; ?>" method="POST">
        <h1 style="margin-top: -50px;">We want to schedule my services for...</h1>
        <table>
        <tr>
            <th>Date</th>
            <th>Breakfast</th>
        ...
        <br>
        <input type="hidden" name="step" value="4"> <!-- New step -->
        <input type="hidden" name="address" value="<?php echo $_POST['address']; ?>">
        <input type="hidden" name="meal" value="<?php echo $_POST['meal']; ?>">
        <input type="hidden" name="mealType" value="<?php echo $_POST['mealType']; ?>">
        <button class="btnBack" type="button" onclick="history.back()">Back</button>
...
<?php } else if ($myStep == 4 && $mealType == 'multiple') {  ?>
    <div class="container step-four" style="text-align: center;">
    <form action="test.php?step=<?php echo $myStep; ?>" method="POST">
    <h1 style="margin-top: -50px">We are...</h1>
        <button class="btn-afr"><b>Adults</b><br> over 16 years of age</button><br><br>
        <button class="btn-afr"><b>Teens</b> <br> over 12-15 years of age</button><br><br>
        <button class="btn-afr"><b>Teens</b> <br> over 2-11 years of age</button><br><br>
...
<?php }else if ($myStep == 4.5) {  ?>
    <div class="container step-four" style="text-align: center;">
    <form action="test.php?step=<?php echo $myStep; ?>" method="POST">
    <h1 style="margin-top: -50px;">It's for...</h1>
        <button class="btn-b">
...
<?php }else if ($myStep == 5) {  ?>
    ...
    <form action="test.php?step=<?php echo $myStep; ?>" method="POST">
    <h1 style="margin-top: -50px;">Our preferred cuisine is...</h1>
...
<?php }else if ($myStep == 6) {  ?>
    ...
    <form action="test.php?step=<?php echo $myStep; ?>" method="POST">
    <h1 style="margin-top: -50px;">Our stove top is...</h1>
...
<?php }else if ($myStep == 8) {  ?>
    ...
    <form action="test.php?step=<?php echo $myStep; ?>" method="POST">
    <h1 style="margin-top: -50px;">We have an oven..</h1>
    ...
    <form action="test.php?step=<?php echo $myStep; ?>" method="POST" onsubmit="return validateForm()">
    <h1 style="margin-top: -50px;">The day...</h1><br><br>
    ...
    <form action="test.php?step=<?php echo $myStep; ?>" method="POST">
    <h1 style="margin-top: -50px;">We're looking for...</h1>
    ...
    <form action="test.php?step=<?php echo $myStep; ?>" method="POST">
    <h1 style="margin-top: -50px;">Any dietary restrictions?.</h1>
    ...
    <form action="test.php?step=<?php echo $myStep; ?>" method="POST">
    <h1 style="margin-top: -50px;">Specifically...</h1>
...
<?php }else if ($myStep == 13) {  ?>
    ...
    <input type="text" name="name" class="writeInfo" placeholder="Enter your name" required><br><br>
    <input type="text" name="email" class="writeInfo" placeholder="Enter your email" required><br><br>
    <input type="text" name="phone" class="writeInfo" placeholder="Enter your phone number" required><br>
