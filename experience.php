...
<body>
    ...
    <!-- Starter Header -->
    <header class="d-flex justify-content-center align-items-center vh-100 bg-image" style="background-image: url('img/expic1.jpg'); background-size: cover; background-position: center;">
        <div class="myclass mainHeading">
            <h1 class="text-light font-weight-bold text-center">Turn your home into a</h1>
            <h1 class="text-light font-weight-bold text-center">restaurant</h1>
...
<div class="container-fluid">
  <div class="chefPro p-4">
    <h1 class="text-center mt-3">A chef for every occasion</h1>
    <p class="text-center mt-3">Every celebration with your family and friends is unique! Find the right chef to level up your next dining experience.</p>
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <div class="cards-wrapper">
        <div class="card w-100">
          <!-- Card content for the first set -->
          <div class="img1">
            <img src="img04/chefwork1.jpg" alt="">
          </div>
          <div class="img2"><img src="img04/malechef1.jpeg" alt=""></div>
            <div class="main-text">
                <h2>Chef Asad Ali</h2>
                <div class="rateSec">
                ...
                <p>Chef Asad Ali specializes in health-conscious Pakistani cuisine, with a strong emphasis on vegetarian and vegan options. With 12 years of experience, his expertise in crafting nutritious and flavorful meals has earned him a loyal clientele who appreciate both taste and well-being.</p>
            </div>
        ...
        <div class="card w-100">
          <!-- Card content for the first set -->
          <div class="img1">
            <img src="img04/DeWatermark.ai_1716313739985 (1).png" alt="">
          </div>
          <div class="img2"><img src="img04/femalechef1.jpeg" alt=""></div>
            <div class="main-text">
                <h2>Chef Memoona Ilyas</h2>
                <div class="rateSec">
                  <span class="rounded-pill pl-2 pr-3 py-1 d-inline-block">
                    <i class="fa fa-star text-warning"></i>
                    <span>5</span>
                  ...
                  <p>With a decade of experience(10 years in private catering and culinary workshops), Chef mamoona Ilyas excels in vibrant Pakistani street food and innovative fusion dishes. Her focus on healthy, flavorful meals and engaging culinary workshops has made her a sought-after name in the culinary world.</p>
            </div>
        </div>
        <div class="card w-100">
          <!-- Card content for the first set -->
          <div class="img1">
            <img src="img04/chefwork9.jpg">
          </div>
          <div class="img2"><img src="img04/malechef6.jpeg" alt=""></div>
            <div class="main-text">
                <h2>Chef Azher Anwar</h2>
                <div class="rateSec">
                  <span class="rounded-pill pl-2 pr-3 py-1 d-inline-block">
                    <i class="fa fa-star text-warning"></i>
                    <span>4.8</span>
                  ...
                  <p>Chef Azher Anwar, with a decade of experience, excels in both Pakistani street food and contemporary fusion cuisine. His innovative approach combines traditional flavors with modern techniques, making him a popular choice for those seeking a unique culinary adventure in the comfort of their home.</p>
            </div>
    ...
    <div class="carousel-item">
      <div class="cards-wrapper">
        <div class="card w-100">
          <!-- Card content for the second set -->
          <div class="img1">
            <img src="img04/chefwork11.jpg">
          </div>
          <div class="img2"><img src="img04/femalechef2.jpeg" alt=""></div>
            <div class="main-text">
                <h2>Chef Aman Iqbal</h2>
                <div class="rateSec">
                  <span class="rounded-pill pl-2 pr-3 py-1 d-inline-block">
                    <i class="fa fa-star text-warning"></i>
                    <span>4.4</span>
                  ...
                  <p>Chef Aman Iqbal has dedicated 15 years to perfecting traditional Pakistani dishes and exquisite desserts. Her passion for baking and pastry arts shines through her delectable sweets and beautifully crafted cakes, making her a favorite for both everyday meals and special occasions.</p>
            </div>
        </div>
        <div class="card w-100">
          <!-- Card content for the second set -->
          <div class="img1">
            <img src="img04/food2.jpeg" alt="">
          </div>
          <div class="img2"><img src="img04/malechef5.jpeg" alt=""></div>
            <div class="main-text">
                <h2>Chef Arif Hussain</h2>
                <div class="rateSec">
                  <span class="rounded-pill pl-2 pr-3 py-1 d-inline-block">
                    <i class="fa fa-star text-warning"></i>
                    <span>4.1</span>
                  ...
                  <p>Chef Arif Hussain brings 15 years of culinary excellence, specializing in authentic Pakistani and Mughlai dishes. Known for his delectable BBQ and masterful use of spices, Chef Arif has catered to numerous private events, ensuring a memorable dining experience with each meal.</p>
            </div>
        </div>
        <div class="card w-100">
          <!-- Card content for the second set -->
          <div class="img1">
            <img src="img04/chefwork4.jpg" alt="">
          </div>
          <div class="img2"><img src="img04/malechef4.jpeg" alt=""></div>
            <div class="main-text">
                <h2>Chef Rauf Haider</h2>
                <div class="rateSec">
                  <span class="rounded-pill pl-2 pr-3 py-1 d-inline-block">
                    <i class="fa fa-star text-warning"></i>
                    <span>4.8</span>
                  ...
                  <p>With 20 years of experience, Chef Rauf Haider is a maestro in all diferent types of food specialties. His gourmet cooking skills have been honed in luxury hotels and private residences, where he consistently delivers exquisite and sophisticated dining experiences.</p>
            </div>
            <!--<div class="socials">
  ...
  <div class="container-fluid">
    <div class="row">
        <div class="col-md-6 content">
            <h2 class="mt-5 pt-5 ms-5">Personalize your experience</h2>
            <p class="ms-4 pt-2 ms-5">Highlight the details of your dreamed meal and your chefs will tailor it for you.</p>
            <ul class="ms-5">
                <li>Budget</li>
                <li>Preferences</li>
                <li>Occasion</li>
        ...
        <div class="col-md-6 image-container">
            <img src="expreirnce-img/chef_work1 (Custom).jpeg" class="img-fluid pt-4 pe-5" alt="Right Side Image">
        </div>
    </div>
  </div>
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-6 image-container">
        <img src="expreirnce-img/our_chef_dispap (Custom).jpeg" class="img-fluid pt-4 pe-5" alt="Right Side Image">
      </div>
        <div class="col-md-6 content">
            <h2 class="mt-5 pt-5 ms-5">Talk with your chefs</h2>
            <p class="ms-4 pt-2 ms-5">Don't be shy to talk with your chefs until your perfect menu is ready!</p>
            <ul class="ms-5">
                <li>Change dishes</li>
                <li>Ask for extras</li>
  ...
  <div class="container-fluid">
    <div class="row">
        <div class="col-md-6 content">
            <h2 class="mt-5 pt-5 ms-5">Enjoy the experience!</h2>
            <p class="ms-4 pt-2 ms-5">Now all there is left to do is waiting for the day till your home turns into a restaurant.</p>
            <ul class="ms-5">
                <li>Hands-on experience</li>
                <li>Table service</li>
                <li>Spotless kitchen</li>
            </ul>
        </div>
        <div class="col-md-6 image-container">
            <img src="expreirnce-img/our_chef1.jpeg" class="img-fluid pt-4 pe-5" alt="Right Side Image">
        </div>
    </div>
  </div>
  <div class="container-fluid">
